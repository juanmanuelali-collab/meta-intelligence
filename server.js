...
async function computeReportFrioData(client, clientId, slug, periodType) {
  ...
  let analytics = null;
  if (propertyId) {
    const [channels, siteMetrics, topPages, devices, demographics, funnel, topItems, keyEvents, browsers, operatingSystems, topSite, channelsByUsers] = await Promise.all([
    ...
    analytics = {
      ...
      browsers, operating_systems: operatingSystems, top_site: topSite, channels_by_users: channelsByUsers,
    };
  }
