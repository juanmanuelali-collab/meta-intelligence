...
const FRIO_ANCHOR_KEYS = [
  ...
  'meta_campanas', 'meta_rendimiento', 'meta_funnel', 'meta_mensajeria', 'meta_engagement', 'meta_video',
  'google_rendimiento', 'google_impression_share', 'google_campanas', 'google_keywords',
...
async function computeReportFrioData(client, clientId, slug, periodType) {
  ...
  let analytics = null;
  if (propertyId) {
    const [channels, siteMetrics, topPages, devices, demographics, funnel, topItems, keyEvents, keyEventsPrev, browsers, operatingSystems, topSite, channelsByUsers, dailySeries, annualUsers, annualChannels] = await Promise.all([
    ...
    analytics = {
      ...
      annual_users_by_month: annualUsers, annual_channels: annualChannels,
    };
  }
