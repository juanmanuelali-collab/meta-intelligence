...
async function fetchAccountMetrics(client) {
  ...
  function calcKpis(data) {
    ...
    // Nuevos action types
    const donations       = getAction(actions, 'donate') || getAction(actions, 'onsite_conversion.donate');
    const igProfileVisits = getAction(actions, 'ig_profile_visit') || getAction(actions, 'onsite_conversion.instagram_profile_visit');
    ...
    return {
      ...
      postEngagement, videoViews, videoViews25, videoViews75, thruPlays, postShares, postSaves,
      newFollowersPage, newFollowersIG,
      leadgenLeads, donations, igProfileVisits,
