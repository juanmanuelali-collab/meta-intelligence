...
app.get('/api/:slug/kpi-targets', async (req, res) => {
  ...
  try {
    ...
    // "KPI Global" — promedio de los últimos 12 meses en vivo (o los que
    // haya con datos), no un solo mes puntual. Es una foto más estable del
    // baseline real que la columna Global usa como referencia.
