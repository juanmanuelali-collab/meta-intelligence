...
async function runAnalysis(client, metricsData) {
  ...
  const mainKpisSection = kpiLines.length > 0
    ? `\nKPIs CONFIGURADOS POR OBJETIVO DE CAMPAÑA:\n${kpiLines.join('\n')}\nAnalizá cada campaña según el KPI correspondiente a su objetivo. No apliques métricas de conversión a campañas de alcance ni viceversa.\n`
    : '';
