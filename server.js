...
app.get('/api/:slug/campaign-plans', async (req, res) => {
  ...
  try {
    ...
    let totalPlanned = 0, totalActual = 0, anyActual = false;
    ...
    res.json({
      ...
      budget_summary: { total_planned: totalPlanned, total_actual: anyActual ? totalActual : null, any_actual: anyActual },
