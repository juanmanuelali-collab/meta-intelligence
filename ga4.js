 ...
 *
 * Autenticación: reutiliza la MISMA Service Account que ya usa el
 * proyecto para loggear costos de IA en Google Sheets (variable de
 * entorno GOOGLE_SERVICE_ACCOUNT). No hace falta ninguna credencial
 * nueva — solo hay que agregar el email de esa Service Account
 * (client_email del JSON) como usuario Viewer en Property Access
 * Management de cada propiedad GA4 que se quiera conectar.
 *
